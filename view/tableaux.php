...
<div class="home-content">
    ...
    <form action="<?= !empty($_GET['id']) ? "../model/modifierval.php" : "../model/ajouteval.php" ?>" method="post">
        ...
        <input value="<?= !empty($_GET['id']) ? $categorie['min'] : "" ?>" type="text" name="min" id="categorie" placeholder="Veuillez saisir le nom">
        
        <label for="max">Max</label><br>
        <input value="<?= !empty($_GET['id']) ? $categorie['max'] : "" ?>" type="text" name="max" id="categorie" placeholder="Veuillez saisir le nom">
        <label for="val">Valeur de remise</label><br>
        <input value="<?= !empty($_GET['id']) ? $categorie['val'] : "" ?>" type="text" name="val" id="categorie" placeholder="Veuillez saisir le nom">
