...
<div class="home-content">
    ...
    <select onchange="setPrix()" name="id_article" id="id_article">
        ...
        ?>
                    <option data-prix="<?= $value['machat'] ?>" value="<?= $value['id_article'] ?>"><?= $value['nomproduit']."-".$value['quantite'] ." متوفر" ?></option>
        <?php
                }
            }
        ?>
    </select>
    <label for="id_client">اسم المورد</label><br>
    ...
    <br><input onkeyup="setPrix()" value="<?= !empty($_GET['id']) ? $article['quantite'] : "" ?>" type="number" name="quantite" id="quantite" placeholder="الرجاء إدخال الكمية">

    <label for="prix">السعر</label>
    <br><input value="<?= !empty($_GET['id']) ? $article['prix'] : "" ?>" type="number" name="prix" id="prix" placeholder="الرجاء إدخال السعر">
