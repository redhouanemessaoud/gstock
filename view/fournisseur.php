    ...
    <div class="overview-boxes">
        <div class="box">
            <form action=" <?= !empty($_GET['id']) ? "../model/modifierfournisseur.php" : "../model/ajoutfournisseur.php " ?> " method="post">
                <label for="nom">Nom de fournisseur</label><br>
               ...
               <label for="prenom">prenom</label>
                <br><input value="<?= !empty($_GET['id']) ? $fournisseur['prenom'] : "" ?>" type="text" name="prenom" id="prenom" placeholder="veuillez saisir le prenom">

                <br><label for="telephone1">telphone </label>
                <br><input value="<?= !empty($_GET['id']) ? $fournisseur['num'] : "" ?>" type="text" name="num" id="num" placeholder="veuillez saisir un numero de telphone">

                <br><label for="address">address</label>
                <br><input value="<?= !empty($_GET['id']) ? $fournisseur['adresse'] : "" ?>" type="text" name="adresse" id="adresse" placeholder="veuillez saisir l'address de fournisseur$fournisseur">
