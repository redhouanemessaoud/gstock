  ...
  <body>
    ...
    <div id="sidebar" class="sidebar">
      <div class="logo-details">
        ...
        <span class="logo_name">Saison Meuble</span><br>
      </div>
     
      <ul class="nav-links">
     
      <div style="text-align: center;">
    <a href="" style="color: white;">fr</a> | <a href="./arabic/dashbord.php" style="color: white;">ع</a>
</div>
        ...
        <li>
          <a href="tableaux.php">
            ...
            <span class="links_name">Benefice</span>
          </a>
        </li>
...
<div class="button-container">
        ...
        <span style='color:white;'>les demandes d'aujourd'hui</span>
        </a>
        </div>
